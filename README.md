...
- Install supporting programs (screen, java, apache, php, zip).
    - On Ubuntu/Debian/Mint: "sudo apt-get install screen openjdk-6-jre libapache2-mod-php5 php5-curl wget zip unzip && /etc/init.d/apache2 reload". (The apache reload should be unnecessary, but is due to Debian bug 705350)
