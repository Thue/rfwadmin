...
-- On Ubuntu/Debian/Mint: "sudo apt-get install screen openjdk-6-jre libapache2-mod-php5 php5-curl wget" .
-- On Redhat/RHEL/CentOS I am guessing that the command should be "sudo yum -y install screen openjdk-7-jre php httpd php-curl wget" (untested).
